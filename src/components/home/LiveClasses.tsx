...
export default function LiveClasses() {
    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                const res = await courseService.getCoursesByType('live', { limit: 9, sortBy: 'createdAt', sortOrder: 'DESC' });
                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex items-center mb-4">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-gray-900">{liveClass.instructor}</p>
                                ...
                                <div className="space-y-3 mb-6">
                                    <div className="flex items-center text-sm text-gray-600">
                                        ...
                                        <span>{t('liveClasses.scheduled')}: {formatDate(liveClass.scheduledAt)}</span>
                                    </div>
                                    <div className="flex items-center text-sm text-gray-600">
                                        ...
                                        <span>
                                            {liveClass.currentParticipants}/{liveClass.maxParticipants} {t('liveClasses.participants')}
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="mb-6">
                                    <div className="flex justify-between text-xs text-gray-500 mb-1">
                                        ...
                                        <span>{Math.round((liveClass.currentParticipants / liveClass.maxParticipants) * 100)}%</span>
                                    </div>
