...
const testimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    comment:
      "Shekhabo completely transformed my career. The courses are well-structured and the instructors are incredibly knowledgeable. I landed my dream job as a full-stack developer!",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "The live classes feature is amazing! Being able to interact with instructors in real-time made all the difference in my learning experience.",
  ...
  },
  {
    ...
    rating: 4,
    comment:
      "Great platform with excellent content. The multi-language support helped me learn in my native language, making complex concepts easier to understand.",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "I love how practical and job-focused the courses are. The skills I learned here directly applied to my work, leading to a promotion within 3 months!",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "The community support and instructor feedback have been exceptional. Shekhabo provides everything you need to succeed in your learning journey.",
  ...
  },
  {
    ...
    rating: 4,
    comment:
      "Flexible learning schedule and high-quality content make this platform perfect for working professionals looking to upskill.",
        ...
        <div className="relative ">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 lg:p-12 max-w-4xl mx-auto">
            <div className="text-center">
              {/* Quote Icon */}
              <svg
                className="w-12 h-12 text-[#51356e] mx-auto mb-6"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
