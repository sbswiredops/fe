  ...
  return (
    ...
    >
      <div className="flex min-h-screen items-center justify-center p-4 text-center sm:p-6">
        ...
        />
        <div
          className={`relative z-50 transform overflow-hidden rounded-2xl bg-white text-left shadow-2xl ring-1 ring-black/5 transition-all my-8 w-full sm:w-auto ${sizeClasses[size]} max-h-[85vh] overflow-y-auto ${className || ""}`}
          role="document"
        >
          {title && (
