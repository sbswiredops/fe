    ...
    <DataTable
      columns={[
        ...
        },
        {
          ...
          header: "Course",
          render: (s: any) => (
            <span className="text-sm text-gray-900">{s.courseName}</span>
          ),
        },
        // show normalized orderIndex (fallback to old `order` if present)
        {
          key: "orderIndex",
          header: "Order",
          render: (s: any) => (
            <span className="text-sm text-gray-900">
              {(s.orderIndex ?? s.order ?? "-").toString()}
            </span>
          ),
        },
        {
          ...
          header: "Lessons",
          render: (s: any) => (
            <span className="text-sm text-gray-900">{s.lessonCount}</span>
          ),
        },
        {
          key: "status",
