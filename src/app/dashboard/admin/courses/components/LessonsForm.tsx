  ...
  return (
    <>
      ...
      <div>
        ...
        <textarea name="content" value={formData.content || ''} onChange={onChange} placeholder="Enter lesson content" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#51356e] text-gray-900" rows={4} required />
      </div>
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">Section</label>
        <select name="sectionId" value={formData.sectionId || ''} onChange={onChange} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#51356e] text-gray-900" required>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input type="file" name="videoUrl" accept="video/*" onChange={onChange} className="block w-full text-sm text-gray-700 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-[#51356e] hover:file:bg-blue-100" />
        ...
        <div>
          ...
          <input type="file" name="resourceUrl" accept="image/*,video/*,application/*" onChange={onChange} className="block w-full text-sm text-gray-700 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-[#51356e] hover:file:bg-blue-100" />
