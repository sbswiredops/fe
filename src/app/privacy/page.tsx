          ...
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <div className="policy-section mb-12">
              ...
              <div className="space-y-4">
                <div className="data-type bg-white border border-gray-200 p-6 rounded-lg">
            ...
            <div className="policy-section mb-12">
              ...
              <div className="use-cases space-y-3">
                <div className="use-case flex items-start space-x-3">
                  <Circle className="text-purple-500 mt-1" size={12} />
                  <p className="text-gray-700">
                ...
                <div className="use-case flex items-start space-x-3">
                  <Circle className="text-purple-500 mt-1" size={12} />
                  <p className="text-gray-700">
                    {t("privacy.dataUse.communication")}
                  </p>
                </div>
                <div className="use-case flex items-start space-x-3">
                  <Circle className="text-purple-500 mt-1" size={12} />
                  <p className="text-gray-700">
                    {t("privacy.dataUse.personalization")}
                  </p>
                </div>
                <div className="use-case flex items-start space-x-3">
                  <Circle className="text-purple-500 mt-1" size={12} />
                  <p className="text-gray-700">
                    {t("privacy.dataUse.analytics")}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="policy-section mb-12">
              ...
              <div className="sharing-conditions space-y-3">
                <div className="condition flex items-start space-x-3">
                  ...
                  <p className="text-gray-700">
                    {t("privacy.dataSharing.consent")}
                  </p>
                </div>
                <div className="condition flex items-start space-x-3">
                  <Check className="text-green-500 mt-1" size={16} />
                  <p className="text-gray-700">
                    {t("privacy.dataSharing.legal")}
                  </p>
                </div>
                <div className="condition flex items-start space-x-3">
                  <Check className="text-green-500 mt-1" size={16} />
                  <p className="text-gray-700">
                    {t("privacy.dataSharing.protection")}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="policy-section mb-12">
              ...
              <div className="security-info bg-white border border-gray-200 p-6 rounded-lg">
            ...
            <div className="policy-section mb-12">
              ...
              <div className="rights-grid grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="right-card bg-white p-6 rounded-lg shadow-md border border-gray-200">
                  <div className="right-icon w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center mb-4">
                ...
                <div className="right-card bg-white p-6 rounded-lg shadow-md border border-gray-200">
                  <div className="right-icon w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center mb-4">
                    <Edit3 className="text-purple-500" size={18} />
                  </div>
                  <h3 className="text-lg font-semibold text-gray-800 mb-2">
                    Correction
                  </h3>
